package br.com.luciano.felipe.forum.controller;
...
import br.com.luciano.felipe.forum.dto.DetalhesTopicoDto;
import br.com.luciano.felipe.forum.dto.TopicoDto;
import br.com.luciano.felipe.forum.form.AtualizacaoTopicoForm;
import br.com.luciano.felipe.forum.form.TopicoForm;
...
public class TopicosController {
    ...
    //  http://localhost:8080/topicos?page=0&size=3&sort=id,asc&sort=dataCriacao,desc
	...
	@PostMapping
	@Transactional
	@CacheEvict(allEntries = true,value = "listaDeTopicos")
	public ResponseEntity<TopicoDto> cadastrar(@RequestBody @Validated TopicoForm form, UriComponentsBuilder builder) {
